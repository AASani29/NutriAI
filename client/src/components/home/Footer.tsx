...
export default function Footer() {
  ...
  const footerLinks = {
    Features: [
      { label: 'Smart Inventory', href: '#features' },
      { label: 'AI Recipes', href: '#features' },
      { label: 'SDG Impact', href: '#impact' },
    ],
    Resources: [
      { label: 'Foodista Blog', href: '/resources' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-16">
          <div className="lg:col-span-2 space-y-4">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="font-bold text-xl text-gray-900 tracking-tight">LocaNutri-Smart</span>
            </Link>
            <p className="text-gray-500 text-sm leading-relaxed max-w-xs">
              A smart digital platform for responsible food consumption and production (SDG 12), reducing waste through AI and community.
            </p>
          </div>
        ...
        <div className="border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 text-sm">
            © {currentYear} LocaNutri-Smart. All rights reserved.
          </p>
