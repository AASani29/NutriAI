         ...
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
               ...
               <div className="flex flex-col gap-8 relative z-10">
                  ...
                  <h1 >
                     <motion.span transition={{ duration: 0.7, ease: 'easeIn' }} whileInView={{ opacity: 1, x: 0 }} initial={{ x: -80, opacity: 0 }} viewport={{ once: true }} className="block ml-4 text-5xl md:text-6xl lg:text-7xl font-display font-bold tracking-tight text-white leading-[1.1]">
                        Manage Food
                     </motion.span><br />
                     <motion.span transition={{ duration: 0.7, ease: 'easeIn', delay: 0.5 }} whileInView={{ opacity: 1, x: 10 }} initial={{ x: -80, opacity: 0 }} viewport={{ once: true }} className="block ml-8 text-5xl md:text-6xl  lg:text-7xl font-display font-bold tracking-tight text-primary-foreground leading-[1.1]">
                        Master Nutrition
                     </motion.span> <br />
                     <motion.span transition={{ duration: 0.9, ease: 'easeIn', delay: 0.7 }} whileInView={{ opacity: 1, x: 20 }} initial={{ x: -80, opacity: 0 }} viewport={{ once: true }} className="block ml-12 text-5xl  md:text-6xl lg:text-7xl font-display font-bold tracking-tight text-primary leading-[1.1]">
                        Minimize Waste
                     </motion.span>
                  </h1>

                  <motion.p transition={{ duration: 0.7, ease: 'easeIn', delay: 0.7 }} whileInView={{ opacity: 1, y: 0 }} initial={{ y: 80, opacity: 0 }} viewport={{ once: true }} className="text-xl font-medium text-gray-100 leading-relaxed max-w-lg pt-10">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 pt-4">
                     <Link
                        ...
                        className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-primary text-white rounded-2xl hover:bg-primary-dark hover:scale-[1.02] transition-all duration-300 font-bold text-lg shadow-xl shadow-primary/20"
                     >
                     ...
                     <a
                        href="#how-it-works"
                        className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white/10 backdrop-blur-md text-white border border-white/20 rounded-2xl hover:bg-white/20 transition-all duration-300 font-bold text-lg"
                     >
                        See How It Works
                     </a>
                  </div>
               ...
               <motion.div transition={{ duration: 1, ease: 'easeIn' }} whileInView={{ opacity: 1, x: 0 }} initial={{ x: 80, opacity: 0 }} viewport={{ once: true }} className="relative w-full h-[600px] hidden lg:block perspective-1000">
                  ...
                  <div className="absolute top-10 right-0 w-[500px] h-[380px] bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden transform rotate-y-[-5deg] hover:rotate-y-0 transition-transform duration-700 p-6 z-10">
                     ...
                     <div className="flex items-center justify-between mb-8 pb-4 border-b border-gray-50">
                        ...
                        <div className="px-3 py-1 bg-secondary/10 text-secondary text-[10px] font-bold rounded-full border border-secondary/20 uppercase tracking-widest">Score: 92/100</div>
                     </div>
                     ...
                     {/* AI Recommendation */}
                     <div className="bg-background p-4 rounded-2xl border border-border flex gap-4">
                  ...
                  <div className="absolute top-1/2 -left-4 bg-white p-4 rounded-2xl shadow-xl border border-gray-100 flex items-center gap-3 animate-float delay-100 z-20">
                     ...
                     <div>
                        ...
                        <div className="text-[10px] font-bold text-secondary">1.2kg saved this week</div>
                     </div>
                  </div>
                  ...
                  <div className="absolute bottom-1/4 -right-8 bg-white p-4 rounded-2xl shadow-xl border border-gray-100 flex items-center gap-3 animate-float delay-300 z-20">
                     ...
                     <div>
                        ...
                        <div className="text-[10px] font-bold text-secondary">Based on your pantry</div>
                     </div>
                  </div>
